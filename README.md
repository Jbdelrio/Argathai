...
Agarthai reste basé sur la même idée : **backtest + live trading** autour de stratégies modulaires, avec un focus execution/risk management pour petit capital.
...
> Note: `live/dashboard.py` (Dash) est conservé en legacy/debug, mais l'interface live officielle est `gui/live_app.py`.
